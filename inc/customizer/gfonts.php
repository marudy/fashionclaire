 ...
 *
 * @since fashionclaire 2.1.1
 */
function fashionclaire_get_font_choices() {
	$fonts = fashionclaire_get_google_fonts();
	$out = array();
...
if ( ! function_exists( 'fashionclaire_get_google_fonts' ) ) :
/**
 ...
 * @since fashionclaire 2.1.1
 */
function fashionclaire_get_google_fonts() {
	return array(
		'0' => array(
			'label'    => __( 'None', 'fashionclaire' ), 
		),		
		'ABeeZee' => array(
			'label'    => 'ABeeZee',
			'variants' => array(
