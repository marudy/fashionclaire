<?php
if (! class_exists('Fashionclaire_Widget_Featured_Posts')) :
    class Fashionclaire_Widget_Featured_Posts extends WP_Widget {
        function __construct(){
            $opts = array(
            'classname' => 'fashionclaire_widget_featured_posts',
            'description' => esc_html__('Displays a number of featured posts from specific category.', 'fashionclaire')

            );
            parent::__construct('ci-featured-posts', esc_html__('Fashionclaire - Featured Posts', 'fashionclaire'), $opts);
        }
        ...
        function widget ($args, $instance){
            ...
            $query_featured = new WP_Query($query_args);
        ...
        function form($instance){
            ...
            <p><label for="<?php echo esc_attr($this->get_field_id('cat') ); ?>"><?php esc_html_e('Category to display the latest posts.', 'fashionclaire') ;?></label>
                <?php $cat_args = array(
                    'taxonomy'          =>  'category',
                    'hide_empty'        =>  0,
                    'show_option_all'   =>  '',
    ...
    register_widget('Fashionclaire_Widget_Featured_Posts');
endif;